def get_response(user_input):
    ...
    responses = {
        ...
        "can you suggest me some good playlist?": "May i know your preferences?",
        "melody": "Playing Ed Sheeran playlist...",
        "can you play the first four songs in a loop?": "Sure! I can do that for you.",
